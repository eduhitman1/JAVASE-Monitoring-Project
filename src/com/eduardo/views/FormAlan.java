...
public class FormAlan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxTipoAnalista.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Alan Oliveria" }));
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        if (jTextFieldNumChamado.getText().isEmpty()) {   // campo não pode está vazio
            ...
            mod.setData_l(dtHoje); //mod.setData_l(jFormattedDataLigacao.getDate(dtHoje.toString()));
