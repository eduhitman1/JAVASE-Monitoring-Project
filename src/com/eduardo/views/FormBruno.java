...
import com.eduardo.domain.BeansBruno;
import com.eduardo.controllers.DaoBruno;
 ...
 */
public class FormBruno extends javax.swing.JFrame {

    BeansBruno mod = new BeansBruno();
    DaoBruno control = new DaoBruno();
    ...
    public FormBruno(String usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxTipoAnalista.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bruno Caetano" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/Acima4/Bruno/RelBruno.jasper", null, con);    //hotname da maquina 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            //JasperPrint print = JasperFillManager.fillReport("//10.70.132.45/c$/Users/t7240049/Documents/NetBeansProjects/MonitoriaProject/Rel/Gerlaine/RelGerlaine.jasper",null,con);     // ip na rede         
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/RelEmail/Bruno/EmailBruno.jasper", null, con);    //hotname da maquina 
            JasperViewer.viewReport(print, false);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, "Erro ao gerar relatório" + ex);
        }
  ...
  jtCOD.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBruno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
