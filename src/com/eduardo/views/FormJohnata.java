...
import com.eduardo.domain.BeansJohnata;
import com.eduardo.controllers.DaoJohnata;
 ...
 */
public class FormJohnata extends javax.swing.JFrame {

    BeansJohnata mod = new BeansJohnata();
    DaoJohnata control = new DaoJohnata();
    ...
    public FormJohnata(String usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxTipoAnalista.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Johnata dias" }));
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        BeansJohnata model = control.buscaChamado(mod);
        ...
        if (jTextFieldPesquisaChamado.getText().isEmpty()) {
            ...
            preencherTabela("select *from johnata where num_c  like'%" + mod.getPesquisa() + "%'"); // BUSCA ESPECIFICA
        }
    ...
    private void jTableChamadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableChamadoMouseClicked
        ...
        conex.conexao();
        conex.executaSql("select *from johnata where cod_c='" + cod_c + "'");
        try {
    ...
    private void jButtonPesquisaEscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisaEscActionPerformed
        ...
        preencherTabela("select *from johnata where tipofor_c like'%" + mod.getPesquisa() + "%'"); //preencherTabela("select *from johnata order by cod_c asc");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/Acima4/Johnata/RelJohnata.jasper", null, con);    //hotname da maquina 
    ...
    private void jButtonPesquisaEspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisaEspActionPerformed
        ...
        if (op == 1) {
            preencherTabela("select *from johnata where tipofer_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 2) {
            preencherTabela("select *from johnata where tipo_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 3) {
            preencherTabela("select *from johnata where status_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 4) {
            preencherTabela("select *from johnata where grupo_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 5) {
            preencherTabela("select *from johnata where data_l like'%" + mod.getPesquisa() + "%'");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            //JasperPrint print = JasperFillManager.fillReport("//10.70.132.45/c$/Users/t7240049/Documents/NetBeansProjects/MonitoriaProject/Rel/Gerlaine/RelGerlaine.jasper",null,con);     // ip na rede         
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/RelEmail/Johnata/EmailJohnata.jasper", null, con);    //hotname da maquina 
            JasperViewer.viewReport(print, false);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, "Erro ao gerar relatório" + ex);
        }
  ...
  jtCOD.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormJohnata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FormJohnata().setVisible(true);
        });
    }
