...
import com.eduardo.controllers.DaoMonique;
 ...
 */
public class FormMonique extends javax.swing.JFrame {

    BeansMonique mod = new BeansMonique();
    DaoMonique control = new DaoMonique();
    ...
    private void initComponents() {
        ...
        jComboBoxTipoAnalista.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Monique Clarck" }));
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        BeansMonique model = control.buscaChamado(mod);
        ...
        if (jTextFieldPesquisaChamado.getText().isEmpty()) {
            ...
            preencherTabela("select *from monique where num_c  like'%" + mod.getPesquisa() + "%'"); // BUSCA ESPECIFICA
        }
    ...
    private void jTableChamadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableChamadoMouseClicked
        ...
        conex.conexao();
        conex.executaSql("select *from monique where cod_c='" + cod_c + "'");
        try {
    ...
    private void jButtonPesquisaEscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisaEscActionPerformed
        ...
        preencherTabela("select *from monique where tipofor_c like'%" + mod.getPesquisa() + "%'"); //preencherTabela("select *from monique order by cod_c asc");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/Acima4/Monique/RelMonique.jasper", null, con);    //hotname da maquina 
    ...
    private void jButtonPesquisaEspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisaEspActionPerformed
        ...
        if (op == 1) {
            preencherTabela("select *from monique where tipofer_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 2) {
            preencherTabela("select *from monique where tipo_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 3) {
            preencherTabela("select *from monique where status_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 4) {
            preencherTabela("select *from monique where grupo_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 5) {
            preencherTabela("select *from monique where data_l like'%" + mod.getPesquisa() + "%'");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            //JasperPrint print = JasperFillManager.fillReport("//10.70.132.45/c$/Users/t7240049/Documents/NetBeansProjects/MonitoriaProject/Rel/Gerlaine/RelGerlaine.jasper",null,con);     // ip na rede         
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/RelEmail/Monique/EmailMonique.jasper", null, con);    //hotname da maquina 
            JasperViewer.viewReport(print, false);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, "Erro ao gerar relatório" + ex);
        }
  ...
  jtCOD.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMonique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FormMonique().setVisible(true);
        });
    }
