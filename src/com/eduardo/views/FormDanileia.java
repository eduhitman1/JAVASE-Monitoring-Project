...
import com.eduardo.domain.BeansDanileia;
import com.eduardo.controllers.DaoDanileia;
 ...
 */
public class FormDanileia extends javax.swing.JFrame {

    BeansDanileia mod = new BeansDanileia();
    DaoDanileia control = new DaoDanileia();
    ...
    public FormDanileia(String usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxTipoAnalista.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Danileia Santiago" }));
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        BeansDanileia model = control.buscaChamado(mod);
        ...
        if (jTextFieldPesquisaChamado.getText().isEmpty()) {
            ...
            preencherTabela("select *from danileia where num_c  like'%" + mod.getPesquisa() + "%'"); // BUSCA ESPECIFICA
        }
    ...
    private void jTableChamadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableChamadoMouseClicked
        ...
        conex.conexao();
        conex.executaSql("select *from danileia where cod_c='" + cod_c + "'");
        try {
    ...
    private void jButtonPesquisaEscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisaEscActionPerformed
        ...
        preencherTabela("select *from danileia where tipofor_c like'%" + mod.getPesquisa() + "%'"); //preencherTabela("select *from danileia order by cod_c asc");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/Acima4/Danileia/RelDanileia.jasper", null, con);    //hotname da maquina 
    ...
    private void jButtonPesquisaEspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisaEspActionPerformed
        ...
        if (op == 1) {
            preencherTabela("select *from danileia where tipofer_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 2) {
            preencherTabela("select *from danileia where tipo_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 3) {
            preencherTabela("select *from danileia where status_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 4) {
            preencherTabela("select *from danileia where grupo_c like'%" + mod.getPesquisa() + "%'");
        } else if (op == 5) {
            preencherTabela("select *from danileia where data_l like'%" + mod.getPesquisa() + "%'");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            //JasperPrint print = JasperFillManager.fillReport("//10.70.132.45/c$/Users/t7240049/Documents/NetBeansProjects/MonitoriaProject/Rel/Gerlaine/RelGerlaine.jasper",null,con);     // ip na rede         
            JasperPrint print = JasperFillManager.fillReport("//nsaodt5nxtfm2/c$/RelMoni/RelEmail/Danileia/EmailDanileia.jasper", null, con);    //hotname da maquina 
            JasperViewer.viewReport(print, false);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, "Erro ao gerar relatório" + ex);
        }
  ...
  jtCOD.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDanileia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FormDanileia().setVisible(true);
        });
    }
